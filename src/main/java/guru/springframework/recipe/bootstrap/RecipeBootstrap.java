...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacamoleRecipe.getIngredients().add(new Ingredient("minces red onion or thinly sliced green onion", new BigDecimal(2), eachUom, guacamoleRecipe));
        guacamoleRecipe.getIngredients().add(new Ingredient("serrano chilies, stems and seeds remove, minced", new BigDecimal(2), eachUom, guacamoleRecipe));
